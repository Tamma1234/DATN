                    ...
                    <table id="simpletable" class="table table-striped table-bordered nowrap">
                        ...
                        @foreach($users as $key => $user)
                            <tr data-id="{{$user->id}}">
                                ...
                                <td><img style="width: 100px" src="{{asset("storage/$user->images")}}" alt="none"></td>
                                <td>
                                     @if($user->gender == 1)
                                    <h4><span class="badge badge-success">Male</span></h4>
                                @else
                                    <h4><span class="badge badge-warning">Female</span></h4>
                                @endif
                            </td>
                                <td>{{$user->birthday}}</td>
                                <td>{{$user->address}}</td>
                                ...
                                <td>
                                    <a class="badge badge-danger" href="{{route('user.delete',['id'=>$user->id])}}">Delete</a>
                                    <a class="badge badge-info" href="{{route('user.edit',['id'=>$user->id])}}">Edit</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
