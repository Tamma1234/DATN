            ...
            <div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
                ...
                <ul class="menu-nav">
                    ...
                    <li class="menu-item menu-item-submenu" data-menu-toggle="click" aria-haspopup="true">
                        <a href="javascript:;" class="menu-link menu-toggle">
                            <span class="menu-text">Sắp ra mắt</span>
                            <i class="menu-arrow"></i>
                        </a>
        ...
        <div class="topbar">
                    ...
                    <form>
                        ...
                        <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(assets/media/misc/bg-1.jpg)">
                            ...
                            <h4 class="d-flex flex-center rounded-top pb-8">
                                <span class="text-white">Thông báo Người dùng</span>
                                <span class="btn btn-text btn-success btn-sm font-weight-bold btn-font-md ml-2">23 thông báo mới</span>
                            </h4>
                            <!--end::Title-->
                        </div>
                        <!--end::Header-->
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active show p-8" id="topbar_notifications_notifications" role="tabpanel">
                                ...
                                <div class="scroll pr-7 mr-n7" data-scroll="true" data-height="300" data-mobile-height="200">
                                    ...
                                    <div class="d-flex align-items-center mb-6">
                                        ...
                                        <div class="d-flex flex-column font-weight-bold">
                                            <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Ứng dụng tuyệt vời</a>
                                            <span class="text-muted">Lập kế hoạch chiến dịch tiếp thị</span>
                                        </div>
                                        <!--end::Text-->
                                    </div>
                                    <!--end::Item-->
                                ...
                                <div class="d-flex flex-center pt-7">
                                    <a href="#" class="btn btn-light-primary font-weight-bold text-center">Xem thêm</a>
                                </div>
                                <!--end::Action-->
                            </div>
                            <!--end::Tabpane-->
            ...
            <div class="dropdown">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                        <img class="h-20px w-20px rounded-sm" src="assets/media/svg/flags/vietnam.svg" alt="" />
                    </div>
                </div>
                <!--end::Toggle-->
                <!--begin::Dropdown-->
                <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                    ...
                    <ul class="navi navi-hover py-4">
                        ...
                        <li class="navi-item active">
                            <a href="#" class="navi-link">
                                <span class="symbol symbol-20 mr-3">
                                    <img src="assets/media/svg/flags/vietnam.svg" alt="" />
                                </span>
                        ...
                        <li class="navi-item">
                            <a href="#" class="navi-link">
                                <span class="symbol symbol-20 mr-3">
                                    <img src="assets/media/svg/flags/united-states.svg" alt="" />
                                </span>
            ...
            <div class="topbar-item">
                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                    ...
                    <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">Lê Trường Giang</span>
